...
# You will use a new variable 'prize' to store a prize name if one was won, and then use the truth of this variable to compose the result message. This will involve two if statements.
...
# At beginning of the code, set prize to None, as the default value
